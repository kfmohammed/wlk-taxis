...
using WLKTaxis.Web.Models;
using WLKTaxis.Web;

namespace WLKTaxis.Web.Controllers
{
    public class CustomerController : ApiController
    {
        ...
        public IEnumerable<CustomerModel> Get()
        {
            ...
            list = (from c in context.Customers
                    select new CustomerModel { Id = c.Id, Name = c.Name, Salary = (long)c.Salary }).AsEnumerable<CustomerModel>();
            return list;
        }
